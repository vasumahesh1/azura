...
.. _program_listing_file_Source_Containers_Benchmark_Vector_benchmark.cpp:

Program Listing for File Vector_benchmark.cpp
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_Source_Containers_Benchmark_Vector_benchmark.cpp>` (``Source\Containers\Benchmark\Vector_benchmark.cpp``)
...
.. code-block:: cpp
   ...
   BENCHMARK_DEFINE_F(VectorBenchmarkFixture, BM_SetWithResize)(benchmark::State& st) {
     for (auto _ : st) {
       Vector<int> v(U32(st.range(0)), U32(st.range(0)), alloc);
