...
.. _program_listing_file_Source_Dibella_Inc_RayTracing_Primitives_Intersection.h:

Program Listing for File Intersection.h
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_Source_Dibella_Inc_RayTracing_Primitives_Intersection.h>` (``Source\Dibella\Inc\RayTracing\Primitives\Intersection.h``)
...
.. code-block:: cpp
   ...
   class Intersection {
    ...
    protected:
     ...
     // t is equal to the distance from the point of intersection to the ray's mOrigin if the ray's mDirection is
     // normalized.
     float mParamT;
