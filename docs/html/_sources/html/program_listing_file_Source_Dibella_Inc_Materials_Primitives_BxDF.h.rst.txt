...
.. _program_listing_file_Source_Dibella_Inc_Materials_Primitives_BxDF.h:

Program Listing for File BxDF.h
===============================

|exhale_lsh| :ref:`Return to documentation for file <file_Source_Dibella_Inc_Materials_Primitives_BxDF.h>` (``Source\Dibella\Inc\Materials\Primitives\BxDF.h``)
...
.. code-block:: cpp
   ...
   class BxDF : protected AllocationDependent {
    public:
     ...
     virtual Color3f SampleF(
         const Vector3f& wo, Vector3f* wi, const Point2f& xi, Float* pdf, BxDFType* sampledType = nullptr) const;
