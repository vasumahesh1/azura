...
#define RAW_STORAGE_FORMAT_ITERATOR(FUNC)                                                                              \
  ...
  FUNC((R11G11B10_FLOAT,                                                                                               \
        /* CHANNELS START */ ((Red, Float, 11))((Green, Float, 11))((Blue, Float, 10)) /* CHANNELS END */))            \
  FUNC((R16G16B16_FLOAT,                                                                                               \
        /* CHANNELS START */ ((Red, Float, 16))((Green, Float, 16))((Blue, Float, 16)) /* CHANNELS END */))            \
  FUNC((R16G16B16_UINT,                                                                                                \
        /* CHANNELS START */ ((Red, UInt, 16))((Green, UInt, 16))((Blue, UInt, 16)) /* CHANNELS END */))               \
  FUNC((R16G16B16_SINT,                                                                                                \
        /* CHANNELS START */ ((Red, SInt, 16))((Green, SInt, 16))((Blue, SInt, 16)) /* CHANNELS END */))               \
  FUNC((R16G16B16_UNORM,                                                                                               \
        /* CHANNELS START */ ((Red, UNorm, 16))((Green, UNorm, 16))((Blue, UNorm, 16)) /* CHANNELS END */))            \
  FUNC((R16G16B16_SNORM,                                                                                               \
        /* CHANNELS START */ ((Red, SNorm, 16))((Green, SNorm, 16))((Blue, SNorm, 16)) /* CHANNELS END */))            \
  FUNC((R16G16B16_USCALED,                                                                                             \
        /* CHANNELS START */ ((Red, UScaled, 16))((Green, UScaled, 16))((Blue, UScaled, 16)) /* CHANNELS END */))      \
  FUNC((R16G16B16_SSCALED,                                                                                             \
        /* CHANNELS START */ ((Red, SScaled, 16))((Green, SScaled, 16))((Blue, SScaled, 16)) /* CHANNELS END */))      \
  ...
  FUNC((R16G16B16A16_FLOAT, /* CHANNELS START */ ((Red, Float, 16))((Green, Float, 16))((Blue, Float, 16))(            \
            (Alpha, Float, 16)) /* CHANNELS END */))                                                                   \
  FUNC((R16G16B16A16_UINT, /* CHANNELS START */ ((Red, UInt, 16))((Green, UInt, 16))((Blue, UInt, 16))(                \
            (Alpha, UInt, 16)) /* CHANNELS END */))                                                                    \
  FUNC((R16G16B16A16_SINT, /* CHANNELS START */ ((Red, SInt, 16))((Green, SInt, 16))((Blue, SInt, 16))(                \
            (Alpha, SInt, 16)) /* CHANNELS END */))                                                                    \
  FUNC((R16G16B16A16_UNORM, /* CHANNELS START */ ((Red, UNorm, 16))((Green, UNorm, 16))((Blue, UNorm, 16))(            \
            (Alpha, UNorm, 16)) /* CHANNELS END */))                                                                   \
  FUNC((R16G16B16A16_SNORM, /* CHANNELS START */ ((Red, SNorm, 16))((Green, SNorm, 16))((Blue, SNorm, 16))(            \
            (Alpha, SNorm, 16)) /* CHANNELS END */))                                                                   \
  FUNC((R16G16B16A16_USCALED, /* CHANNELS START */ ((Red, UScaled, 16))((Green, UScaled, 16))((Blue, UScaled, 16))(    \
            (Alpha, UScaled, 16)) /* CHANNELS END */))                                                                 \
  FUNC((R16G16B16A16_SSCALED, /* CHANNELS START */ ((Red, SScaled, 16))((Green, SScaled, 16))((Blue, SScaled, 16))(    \
            (Alpha, SScaled, 16)) /* CHANNELS END */))                                                                 \
  FUNC((R32G32B32_FLOAT,                                                                                               \
        /* CHANNELS START */ ((Red, Float, 32))((Green, Float, 32))((Blue, Float, 32)) /* CHANNELS END */))            \
  FUNC((R32G32B32_UINT,                                                                                                \
        /* CHANNELS START */ ((Red, UInt, 32))((Green, UInt, 32))((Blue, UInt, 32)) /* CHANNELS END */))               \
  FUNC((R32G32B32_SINT,                                                                                                \
        /* CHANNELS START */ ((Red, SInt, 32))((Green, SInt, 32))((Blue, SInt, 32)) /* CHANNELS END */))               \
  ...
  FUNC((R32G32B32A32_FLOAT, /* CHANNELS START */ ((Red, Float, 32))((Green, Float, 32))((Blue, Float, 32))(            \
            (Alpha, Float, 32)) /* CHANNELS END */))                                                                   \
  FUNC((R32G32B32A32_UINT, /* CHANNELS START */ ((Red, UInt, 32))((Green, UInt, 32))((Blue, UInt, 32))(                \
            (Alpha, UInt, 32)) /* CHANNELS END */))                                                                    \
  FUNC((R32G32B32A32_SINT, /* CHANNELS START */ ((Red, UInt, 32))((Green, UInt, 32))((Blue, UInt, 32))(                \
            (Alpha, UInt, 32)) /* CHANNELS END */))                                                                    \
  FUNC((R64G64B64_FLOAT,                                                                                               \
        /* CHANNELS START */ ((Red, Float, 64))((Green, Float, 64))((Blue, Float, 64)) /* CHANNELS END */))            \
  FUNC((R64G64B64_UINT,                                                                                                \
        /* CHANNELS START */ ((Red, UInt, 64))((Green, UInt, 64))((Blue, UInt, 64)) /* CHANNELS END */))               \
  FUNC((R64G64B64_SINT,                                                                                                \
        /* CHANNELS START */ ((Red, SInt, 64))((Green, SInt, 64))((Blue, SInt, 64)) /* CHANNELS END */))               \
  FUNC((R64G64B64A64_FLOAT, /* CHANNELS START */ ((Red, Float, 64))((Green, Float, 64))((Blue, Float, 64))(            \
            (Alpha, Float, 64)) /* CHANNELS END */))                                                                   \
  FUNC((R64G64B64A64_UINT, /* CHANNELS START */ ((Red, UInt, 64))((Green, UInt, 64))((Blue, UInt, 64))(                \
            (Alpha, UInt, 64)) /* CHANNELS END */))                                                                    \
  FUNC((R64G64B64A64_SINT, /* CHANNELS START */ ((Red, SInt, 64))((Green, SInt, 64))((Blue, SInt, 64))(                \
            (Alpha, SInt, 64)) /* CHANNELS END */))                                                                    \
  FUNC((D24_UNORM_S8_UINT, /* CHANNELS START */ ((Depth, UNorm, 24))((Stencil, UInt, 8)) /* CHANNELS END */))          \
  FUNC((D32_FLOAT_S8X24_UINT,                                                                                          \
        /* CHANNELS START */ ((Depth, Float, 32))((Stencil, UInt, 8))((Padding, Float, 24)) /* CHANNELS END */))       \
