...
.. _program_listing_file_Source_Azura_RenderSystem_Inc_D3D12_D3D12ScopedImage.h:

Program Listing for File D3D12ScopedImage.h
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_Source_Azura_RenderSystem_Inc_D3D12_D3D12ScopedImage.h>` (``Source\Azura\RenderSystem\Inc\D3D12\D3D12ScopedImage.h``)
