...
.. _program_listing_file_Source_Samples_2_DeferredRenderer_Src_ForwardPlusComputeScene.cpp:

Program Listing for File ForwardPlusComputeScene.cpp
====================================================

|exhale_lsh| :ref:`Return to documentation for file <file_Source_Samples_2_DeferredRenderer_Src_ForwardPlusComputeScene.cpp>` (``Source\Samples\2_DeferredRenderer\Src\ForwardPlusComputeScene.cpp``)
...
.. code-block:: cpp
   ...
   void ForwardPlusComputeScene::Initialize(Window& window,
     ...
     m_pass.m_gBufferPassId = renderPassRequirements.AddPass({
       ...
       PipelinePassCreateInfo::OutputTargets{GBUFFER_1, GBUFFER_2, GBUFFER_3, DEPTH_BUFFER},
     ...
     m_pass.m_computePassId = renderPassRequirements.AddPass({
       ...
       PipelinePassCreateInfo::OutputTargets{LIGHT_TARGET, CLUSTER_TARGET},
       PipelinePassCreateInfo::OutputBuffers{},
